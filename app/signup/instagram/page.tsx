      ...
      <div className="w-1/2 bg-white p-8 flex flex-col">
        ...
        <div className="flex flex-col items-center justify-center flex-grow">
          <div className="max-w-md mx-auto text-center">
            ...
            <h1 className="text-4xl font-bold text-gray-800 mb-4">Connect with Instagram</h1>

            <p className="text-gray-600">Supercharge your social media marketing with Instagram Automation.</p>
          </div>
        </div>
      </div>
